...
function Stepper() {
  ...
  // source
  const [source, setQuestionSource] = useState("");
  ...
  const handleUpload = async() => {
    if (typeof questionData[0].question === "string") {
      const questionObj = {
        question: questionData[0].question,
        question_type:questionData[0].questionType,
        question_marks:questionData[0].marks,
        question_source:questionData[0].source,
        question_level: questionData[0].difficultyLevel,
        option: {
          option1: questionData[0].optionA,
          option2: questionData[0].optionB,
          option3: questionData[0].optionC,
          option4: questionData[0].optionD
      },
      answer: questionData[0].correctAnswer,
      is_used: false
      };
      const course_id = course.courseId;
      const class_id = classes.classId;
      const subject_id = subject.subjectId;
      const chapter_id = chapter.chapterId;
      const topic_id = topic.topicId;
      ...
      <div className="flex flex-col items-center mt-8 px-4 w-full ">
        ...
        <div>
          ...
          <div className="flex items-start w-full mt-6 mb-4">
            ...
            {currentStep === 5 ? (
              ...
              <UploadPreview questionData={questionData} />
            )}
          </div>
        </div>
        ...
        <div className="mt-6 mb-4 flex justify-between w-full px-4 lg:px-12">
          ...
          <button
            ...
            onClick={currentStep === 6 ? handleUpload : goToNextStep}
          >
            {currentStep === 6 ? "UPLOAD" : "NEXT"}
          </button>
        </div>
      </div>
    </div>
